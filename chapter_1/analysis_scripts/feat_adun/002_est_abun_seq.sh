...
FEATURES="/rhome/cfisc004/bigdata/projects/kmers_arabidopsis/data/sequences/A_thal_repeats_only.fa"
...
RESULTS="/rhome/cfisc004/bigdata/projects/kmers_arabidopsis/results/feat_abund/parts"
