...
IN=/rhome/cfisc004/bigdata/projects/kmers_arabidopsis/data/sequences/simple_repeats.txt
OUT=/rhome/cfisc004/bigdata/projects/kmers_arabidopsis/results/feat_abund/simple_repeats.txt
ABUN_TABLE=../../results/feat_abund/A_thal_kmer_abund.txt
...
mv "$ABUN_TABLE" ../../results/feat_abund/old2.txt
