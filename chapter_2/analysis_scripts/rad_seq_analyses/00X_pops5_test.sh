...
OUTDIR=/rhome/cfisc004/bigdata/projects/capsella_radseq/results/stacks/pops5
POPMAP=/rhome/cfisc004/bigdata/projects/capsella_radseq/data/popmap_filter2.txt

# pops call with filters
## snp based genotypes
populations -t "$THREADS" --popmap "$POPMAP" -P "$DIR" -O "$OUTDIR" -r 0.60 --min-maf 0.01 --max-obs-het 0.05 \
