...
OUTDIR=/rhome/cfisc004/bigdata/projects/capsella_radseq/results/stacks/pops1
POPMAP=/rhome/cfisc004/bigdata/projects/capsella_radseq/data/popmap.txt

# pops call no filtering
populations -t "$THREADS" --popmap "$POPMAP" -P "$DIR" -O "$OUTDIR" --vcf --verbose
